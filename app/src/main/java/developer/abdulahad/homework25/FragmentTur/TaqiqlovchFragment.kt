...
import developer.abdulahad.homework25.databinding.FragmentTaqiqlovchBinding

class TaqiqlovchFragment : Fragment() {
    lateinit var binding: FragmentTaqiqlovchBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTaqiqlovchBinding.inflate(layoutInflater)
